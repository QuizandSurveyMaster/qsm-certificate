		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<p><a href="https://quizandsurveymaster.com/docs/add-ons/certificate/#4_PDF_Resolution" target="_blank"><?php esc_html_e('Click here', 'qsm-certificate') ?></a> <?php esc_html_e('to learn about PDF resolution.', 'qsm-certificate'); ?></p>
				</td>
			</tr>
			<tr>
				<td width="30%">
