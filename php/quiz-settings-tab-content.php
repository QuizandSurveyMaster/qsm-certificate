...
function qsm_addon_certificate_quiz_settings_tabs_content() {
    ...
    $certificate_settings = array(
		...
		'certificate_id_err_msg_wrong_txt' 		=>	(isset($_POST["certificate_id_err_msg_wrong_txt"]) && !empty($_POST["certificate_id_err_msg_wrong_txt"])) ? $_POST["certificate_id_err_msg_wrong_txt"] : __('Certificate ID is missing!', 'qsm-certificate'),
	...
	'textarea_rows' => 10,
			...
			<tr>
				...
				<td><input type="text" id="certificate_id_err_msg_wrong_txt" name="certificate_id_err_msg_wrong_txt" value="<?php echo isset($certificate_settings["certificate_id_err_msg_wrong_txt"]) ? esc_attr($certificate_settings["certificate_id_err_msg_wrong_txt"]) : __("Certificate ID is missing!", 'qsm-certificate'); ?>">
				</td>
			</tr>
			<tr valign="top" class="qsm_advance_certificate_feature" style="display: none;">
				<td width="30%">
