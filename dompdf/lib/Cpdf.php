...
class Cpdf
{
     ...
     */
    public $currentLineTransparency = [
		"mode"    => "Normal",
		"opacity" => 1.0,
	];
     ...
     */
    public $currentFillTransparency = [
		"mode"    => "Normal",
		"opacity" => 1.0,
	];
...
EOT;
    ...
    protected function o_image( $id, $action, $options = '' ) {
        switch ( $action ) {
            case 'new':
                ...
                $this->o_pages($this->currentNode, 'xObject', [
					'label'  => $options['label'],
					'objNum' => $id,
				]);
    ...
    protected function o_extGState( $id, $action, $options = "" ) {
        ...
        switch ( $action ) {
            case "new":
                ...
                $this->numStates++;
                $this->o_pages($this->currentNode, 'extGState', [
					"objNum"   => $id,
    ...
    function setEncryption( $userPass = '', $ownerPass = '', $pc = [] ) {
        ...
        if ( $this->arc4_objnum == 0 ) {
            ...
            $this->o_encryption($this->numObj, 'new', [
				'user'  => $userPass,
				'owner' => $ownerPass,
				'p'     => $p,
			]);
