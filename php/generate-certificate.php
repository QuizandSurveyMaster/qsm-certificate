 ...
 */
function qsm_addon_certificate_generate_certificate( $quiz_results, $return_file = false , $regenerate = false ) {
	...
	if ( 0 == $certificate_settings["enabled"] ) {
		...
		if ( ! file_exists( $upload['basedir'] . "/qsm-certificates/$filename" ) || true === $regenerate ) {
