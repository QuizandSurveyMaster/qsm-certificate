...
function qsm_pdf_html_post_process_certificate( $html, $settings = array(), $quiz_results = array() ) {
	...
	$html_top       .= '</style></head><body style="background-size:100%;background-image: url('.$background.');background-repeat:no-repeat;background-position:center center;padding:20px; ">';
